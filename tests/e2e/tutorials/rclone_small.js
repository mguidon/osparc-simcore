...
async function runTutorial() {
  ...
  try {
    ...
    const studyData = await tutorial.openTemplate(1000, 1800000); // timeout after clicking on the template to take the screenshot at the correct point in time
    ...
    await tutorial.leave(studyId, 30000);
  }
